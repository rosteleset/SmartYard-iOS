//
//  SendDetailsViewController+Calendar.swift
//  SmartYard
//
...
extension SendDetailsViewController {
...
extension SendDetailsViewController: JTACMonthViewDelegate, JTACMonthViewDataSource {
    func calendar(
    ...
    func calendar(_ calendar: JTACMonthView, shouldSelectDate date: Date, cell: JTACDayCell?, cellState: CellState, indexPath: IndexPath) -> Bool {
        ...
        if !rangeSelected.contains(date), cellState.selectionType == .userInitiated {
            if let fromday = calendarRangeSelect.fromDay {
                ...
                rangeTrigger.onNext(self.calendarRangeSelect)
            } else {
