...
class FullscreenHomePlayerViewController: UIViewController, LoaderPresentable {
    ...
    private let viewModel: FullscreenHomeViewModel
    ...
    init(
        ...
        viewModel: FullscreenHomeViewModel,
        camId: Int,
        position: CGRect? = nil
    ) {
...
//                    self?.areObjectsGrantAccessed.onNext(newDict)
    ...
    private func bind() {
        ...
        var input = FullscreenHomeViewModel.Input(
...
extension FullscreenHomePlayerViewController: UIScrollViewDelegate {
...
extension FullscreenHomePlayerViewController {
