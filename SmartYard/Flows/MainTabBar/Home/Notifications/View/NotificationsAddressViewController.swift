...
class NotificationsAddressViewController: BaseViewController, LoaderPresentable {
    ...
    private let viewModel: NotificationsAddressViewModel
    
    private let shareUrlTrigger = PublishSubject<URL>()
    
    init(viewModel: NotificationsAddressViewModel) {
...
//        webView.layer.maskedCorners = .topCorners
    ...
    private func bind() {
        let input = NotificationsAddressViewModel.Input(
...
extension NotificationsAddressViewController: WKNavigationDelegate {
